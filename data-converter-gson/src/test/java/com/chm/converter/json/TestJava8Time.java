...
public class TestJava8Time {
    ...
    public void testGson() {
        ...
        String encodeToString = gsonConverter.encodeToString(this.java8Time);
        ...
        StaticLog.info("{}", gsonConverter.convertToJavaObject(gsonConverter.encodeToString(new Date()), Date.class));
        assertEquals(java8Time, this.java8Time);
    }

    @Test
    public void tesGsonCacheObjectWriter() {
