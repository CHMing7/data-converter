package com.chm.converter.core.text;
...
public class StrFormatter {
    ...
    public static String format(final String strPattern, final Object... argArray) {
        ...
        for (int argIndex = 0; argIndex < argArray.length; argIndex++) {
            ...
            // 转义符
            if (delimIndex > 0 && strPattern.charAt(delimIndex - 1) == StringPool.C_BACKSLASH) {
                // 双转义符
                if (delimIndex > 1 && strPattern.charAt(delimIndex - 2) == StringPool.C_BACKSLASH) {
                    ...
                    argIndex--;
                    sbuf.append(strPattern, handledPosition, delimIndex - 1);
                    sbuf.append(StringPool.C_DELIM_START);
