...
public class JacksonIonConverter implements IonConverter {
    ...
    public static final List<Class<? extends Annotation>> JACKSON_ION_ANNOTATION_LIST = ListUtil.of(JsonProperty.class);

    public static final String[] CBOR_NAME_ARRAY = new String[]{"com.fasterxml.jackson.dataformat.ion.IonFactory",
